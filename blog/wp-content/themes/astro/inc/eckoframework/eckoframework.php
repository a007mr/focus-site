<?php
    ...
    function ecko_widgets_init(){
        register_sidebar(
            array(
                'name' => esc_html('Page Sidebar', 'astro'),
                'id' => 'sidebar-page',
                'description' => esc_html('Appears in the sidebar area on default blog & custom pages.', 'astro'),
        ...
        register_sidebar(
            array(
                'name' => esc_html('Post Sidebar', 'astro'),
                'id' => 'sidebar-post',
                'description' => esc_html('Appears in the sidebar area on post pages.', 'astro'),
                'before_widget' => '<section class="widget %2$s">',
                'after_widget' => '</section>',
                'before_title' => '<h3 class="widget-title">',
                'after_title' => '</h3><hr>'
    ...
    function ecko_time_ago($time){
        return human_time_diff($time) . esc_html__(' ago', 'astro');
    }
    ...
    function ecko_customize_register($wp_customize){
        ...
        $wp_customize->add_section('general_section',
            array(
                'title' => esc_html('General', 'astro'),
                'description' => esc_html('This section contains general theme options.', 'astro'),
                'priority' => 9,
            )
        );
        ...
        $wp_customize->add_control('general_blog_description',
            array(
                'label' => esc_html('Blog Profile Description', 'astro'),
        ...
        $wp_customize->add_control('general_use_custom_date_format',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Use WordPress Date Format', 'astro'),
                'section' => 'general_section',
            )
        );
        ...
        $wp_customize->add_control('general_hidecomments',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Hide Comments on Load', 'astro'),
                'section' => 'general_section',
            )
        );
        ...
        $wp_customize->add_control('general_disable_syntax_highlighter',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Disable Syntax Highlighter', 'astro'),
                'section' => 'general_section',
            )
        );
        ...
        $wp_customize->add_control('general_use_extended_char_set',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Use Extended Character Set', 'astro'),
                'section' => 'general_section',
            )
        );
        ...
        $wp_customize->add_control('general_disqus_plugin_support',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Enable Disqus Plugin Support', 'astro'),
                'section' => 'general_section',
            )
        );
        ...
        $wp_customize->add_section('typography_section',
            array(
                'title' => esc_html('Typography', 'astro'),
                'description' => esc_html('This section contains theme typography/font options.', 'astro'),
                'priority' => 10,
            )
        );
        ...
        if(defined('ECKO_FONT_BODY_FAMILY')){
            ...
            $wp_customize->add_control('typography_body',
                array(
                    'label' => esc_html('Body Font', 'astro'),
        ...
        if(defined('ECKO_FONT_BODY_ALT_FAMILY')){
            ...
            $wp_customize->add_control('typography_body_alernative',
                array(
                    'label' => esc_html('Body (Alternative) Font', 'astro'),
                    'section' => 'typography_section',
                    'type' => 'select',
                    'choices' => ecko_get_google_font_list()
                )
        ...
        if(defined('ECKO_FONT_HEADER_FAMILY')){
            ...
            $wp_customize->add_control('typography_header',
                array(
                    'label' => esc_html('Header Font', 'astro'),
                    'section' => 'typography_section',
                    'type' => 'select',
                    'choices' => ecko_get_google_font_list()
                )
        ...
        if(defined('ECKO_FONT_SUB_HEADER_FAMILY')){
            ...
            $wp_customize->add_control('typography_sub_header',
                array(
                    'label' => esc_html('Sub Header Font', 'astro'),
                    'section' => 'typography_section',
                    'type' => 'select',
                    'choices' => ecko_get_google_font_list()
                )
        ...
        if(defined('ECKO_FONT_POST_FAMILY')){
            ...
            $wp_customize->add_control('typography_post',
                array(
                    'label' => esc_html('Post Font', 'astro'),
                    'section' => 'typography_section',
                    'type' => 'select',
                    'choices' => ecko_get_google_font_list()
                )
        ...
        $wp_customize->add_section('branding_section',
            array(
                'title' => esc_html('Branding', 'astro'),
                'description' => esc_html('This section contains branding/logo theme options.', 'astro'),
                'priority' => 11,
            )
        );
        ...
        $wp_customize->add_control(
            new WP_Customize_Image_Control($wp_customize, 'general_blog_image',
                array(
                    'label' => esc_html('Blog Logo', 'astro'),
        ...
        $wp_customize->add_control(
            new WP_Customize_Image_Control($wp_customize, 'general_blog_image_retina',
                array(
                    'label' => esc_html('Blog Logo (Retina - @2x file name)', 'astro'),
                    'section' => 'branding_section',
        ...
        $wp_customize->add_control(
            new WP_Customize_Image_Control($wp_customize, 'general_blog_light_image',
                array(
                    'label' => esc_html('Blog Logo (Light)', 'astro'),
                    'section' => 'branding_section',
        ...
        $wp_customize->add_control(
            new WP_Customize_Image_Control($wp_customize, 'general_blog_image_light_retina',
                array(
                    'label' => esc_html('Blog Logo (Light) (Retina - @2x file name)', 'astro'),
                    'section' => 'branding_section',
        ...
        $wp_customize->add_section('social_section',
            array(
                'title' => esc_html('Social Profiles', 'astro'),
                'description' => esc_html('This section contains options for social profiles.', 'astro'),
                'priority' => 39,
            )
        );
        ...
        $wp_customize->add_control('social_twitter',
            array(
                'label' => esc_html('Twitter Profile URL', 'astro'),
        ...
        $wp_customize->add_control('social_facebook',
            array(
                'label' => esc_html('Facebook Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_google',
            array(
                'label' => esc_html('Google+ Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_dribbble',
            array(
                'label' => esc_html('Dribbble Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_instagram',
            array(
                'label' => esc_html('Instagram Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_github',
            array(
                'label' => esc_html('Github Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_youtube',
            array(
                'label' => esc_html('Youtube Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_pinterest',
            array(
                'label' => esc_html('Pinterest Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_linkedin',
            array(
                'label' => esc_html('LinkedIn Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_skype',
            array(
                'label' => esc_html('Skype URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_tumblr',
            array(
                'label' => esc_html('Tumblr URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_flickr',
            array(
                'label' => esc_html('Flickr Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_reddit',
            array(
                'label' => esc_html('Reddit Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_stackoverflow',
            array(
                'label' => esc_html('StackOverflow Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_twitch',
            array(
                'label' => esc_html('Twitch Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_vine',
            array(
                'label' => esc_html('Vine Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_vk',
            array(
                'label' => esc_html('VK Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_vimeo',
            array(
                'label' => esc_html('Vimeo Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_weibo',
            array(
                'label' => esc_html('Weibo Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('social_soundcloud',
            array(
                'label' => esc_html('Soundcloud Profile URL', 'astro'),
                'section' => 'social_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('color_enable_custom',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Enable Custom Colors (Below)', 'astro'),
                'section' => 'colors',
            )
        );
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                'color_accent',
                array(
                    'label' => esc_html('Color Accent', 'astro'),
                    'section' => 'colors',
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                'color_accent_light',
                array(
                    'label' => esc_html('Color Accent Light', 'astro'),
                    'section' => 'colors',
        ...
        $wp_customize->add_control(
            new WP_Customize_Color_Control(
                ...
                'color_accent_dark',
                array(
                    'label' => esc_html('Color Accent Dark', 'astro'),
                    'section' => 'colors',
        ...
        $wp_customize->add_section('og_section',
            array(
                'title' => esc_html('OpenGraph', 'astro'),
                'description' => esc_html('This section contains options for OpenGraph integration.', 'astro'),
                'priority' => 42,
            )
        );
        ...
        $wp_customize->add_control('og_disable',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Disable OpenGraph Integration', 'astro'),
                'section' => 'og_section',
            )
        );
        ...
        $wp_customize->add_control('og_facebook_app_id',
            array(
                'label' => esc_html('Facebook App ID', 'astro'),
                'section' => 'og_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_control('og_facebook_admin_id',
            array(
                'label' => esc_html('Facebook Admin ID', 'astro'),
                'section' => 'og_section',
                'type' => 'text',
            )
        );
        ...
        $wp_customize->add_section('copyright_section',
            array(
                'title' => esc_html('Copyright', 'astro'),
                'description' => esc_html('This section contains options copyright disclaimer.', 'astro'),
                'priority' => 43,
            )
        );
        ...
        $wp_customize->add_control('copyright_hide_disclaimer',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Hide Copyright Disclaimer', 'astro'),
        ...
        $wp_customize->add_control('copyright_hide_wordpress',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Hide "Published With" text', 'astro'),
                'section' => 'copyright_section',
            )
        );
        ...
        $wp_customize->add_control('copyright_hide_ecko',
            array(
                'type' => 'checkbox',
                'label' => esc_html('Hide "Theme by Ecko" text', 'astro'),
                'section' => 'copyright_section',
            )
        );
        ...
        $wp_customize->add_control('copyright_upper_html',
            array(
                'type' => 'text',
                'label' => esc_html('Override Upper Copyright HTML', 'astro'),
                'section' => 'copyright_section',
            )
        );
        ...
        $wp_customize->add_control('copyright_lower_html',
            array(
                'type' => 'text',
                'label' => esc_html('Override Lower Copyright HTML', 'astro'),
                'section' => 'copyright_section',
            )
        );
        ...
        $wp_customize->add_section('advanced_section',
            array(
                'title' => esc_html('Advanced', 'astro'),
                'description' => esc_html('This section contains advanced theme options.', 'astro'),
                'priority' => 130,
            )
        );
        ...
        $wp_customize->add_control('advanced_custom_css',
            array(
                'type' => 'textarea',
                'label' => esc_html('Custom Theme CSS', 'astro'),
